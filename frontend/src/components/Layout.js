...
const navigation = [
  ...
  { name: 'My Dashboard', href: '/operator/dashboard', icon: LayoutDashboard, roles: ['operator'] },
  { name: 'My Dashboard', href: '/mechanic/dashboard', icon: LayoutDashboard, roles: ['mechanic'] },
  { name: 'Field Operations', href: '/field-operations', icon: Tractor, roles: ['operator'] },
  { name: 'Job Board', href: '/maintenance', icon: Wrench, roles: ['mechanic'] },
